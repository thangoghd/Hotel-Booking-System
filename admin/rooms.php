...
<body class="bg-light">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="text-end mb-4">
                            <button type="button" class="btn btn-dark shadow-none btn-sm" data-bs-toggle="modal" data-bs-target="#addRoom">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Childen (Max.)</label>
                            ...
                            <label class="form-label fw-bold">Decription</label>
                                <textarea name="decription" rows="6" class="form-control shadow-" required></textarea>
                            </div>
                        </div>
    ...
    <!-- Modal thay đổi ảnh đại diện cho phòng -->
