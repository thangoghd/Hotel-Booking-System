...
<body class="bg-light">
    ...
    <!-- Phòng khách sạn -->
    <div class="my-5 px-4">
      <h2 class="fw-bold h-font text-center">VỀ PHÒNG CỦA CHÚNG TÔI</h2>
            ...
            <div class="container-fluid flex-lg-column align-items-stretch">
              ...
              <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                <div class="border bg-light p-3 rounded mb-3">
                  ...
                  <input type="date" class="form-control shadow-none mb-3" id="">
                  <label class="form-label">Trả phòng</label>
                  <input type="date" class="form-control shadow-none mb-3" id="">
                </div>
                <div class="border bg-light p-3 rounded mb-3">
                  <h5 class="mb-3" style="font-size: 18px;">Tiện ích chính</h5>
                  <div class="mb-2">
                    <input type="checkbox" class="form-check-input shadow-none mb-3" id="f1">  
                    <label class="form-check-label" for="f1">Tiện ích một</label>
                  </div>
                  <div class="mb-2">
                    <input type="checkbox" class="form-check-input shadow-none mb-3" id="f2">  
                    <label class="form-check-label" for="f2">Tiện ích hai</label>
                  </div>
                  <div class="mb-2">
                    <input type="checkbox" class="form-check-input shadow-none mb-3" id="f3">  
                    <label class="form-check-label" for="f3">Tiện ích ba</label>
                  </div>

                </div>
                <div class="border bg-light p-3 rounded mb-3">
                  <h5 class="mb-3" style="font-size: 18px;">Số khách</h5>
                  <div class="d-flex">
                    <div class="me-3">
          ...
          while ($room_data = mysqli_fetch_assoc($room_res)) 
          {
            ...
            while ($fac_row = mysqli_fetch_assoc($fac_q))
            {
              $facilities_filter .= "
                <div class='mb-2'>
                  <input type='checkbox' class='form-check-input shadow-none mb-3' id='f1'>  
                  <label class='form-check-label' for='f1'>$fac_row[name]</label>
                </div>
              ";
            }
              ...
              <div class="card mb-4 border-0 shadow">
                <div class="row g-0 p-3 align-items-center">
                  ...
                  <div class="col-md-5 px-lg-3 px-md-3 px-0">
                    <h5 class="mb-3">Phòng $room_data[name]</h5>
